 ...
 * */
task(
    'BIT-technology-configure-and-handover-to-research',
    'Technology Multisig configures the Bit contract and initiates handover to Research Multisig',
)
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        await hre.run('BIT-technology-set-treasury-to-research', {
                dryRun: true,
            },
        );
        ...
        await hre.run('BIT-technology-pause', { dryRun: true });
        ...
        await hre.run('BIT-technology-grant-default-admin-role-to-research', { dryRun: true });
